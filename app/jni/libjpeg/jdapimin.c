...
jpeg_CreateDecompress(j_decompress_ptr
cinfo,
int version, size_t
structsize) {
int i;
...
jpeg_destroy_decompress(j_decompress_ptr
cinfo) {
jpeg_destroy((j_common_ptr)
...
jpeg_abort_decompress(j_decompress_ptr
cinfo) {
...
default_decompress_parms(j_decompress_ptr
cinfo) {
...
break;
default:
WARNMS1(cinfo, JWRN_ADOBE_XFORM, cinfo
->Adobe_transform);
cinfo->
...
TRACEMS3(cinfo,
1, JTRC_UNKNOWN_IDS, cid0, cid1, cid2);
cinfo->
jpeg_color_space = JCS_YCbCr; /* assume it's YCbCr */
}
}
...
jpeg_consume_input(j_decompress_ptr
cinfo) {
...
/* Start-of-datastream actions: reset appropriate modules */
        (*cinfo->inputctl->reset_input_controller)
(cinfo);
...
GLOBAL(boolean)
jpeg_input_complete(j_decompress_ptr
cinfo) {
...
GLOBAL(boolean)
jpeg_has_multiple_scans(j_decompress_ptr
cinfo) {
...
GLOBAL(boolean)
jpeg_finish_decompress(j_decompress_ptr
cinfo) {
