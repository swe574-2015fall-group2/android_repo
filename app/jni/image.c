...
JNIEXPORT void Java_in_co_madhur_chatbubblesdemo_AndroidUtilities_blurBitmap(JNIEnv *env,
                                                                             jclass class,
                                                                             jobject bitmap,
                                                                             int radius) {
    if (!bitmap) {
...
JNIEXPORT void Java_in_co_madhur_chatbubblesdemo_AndroidUtilities_loadBitmap(JNIEnv *env,
                                                                             jclass class,
                                                                             jstring path,
                                                                             jobject bitmap,
                                                                             int scale, int width,
