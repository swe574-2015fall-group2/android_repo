...
JNIEXPORT void JNICALL Java_swe574_boun_edu_androidproject_tools_AndroidUtilities_blurBitmap(JNIEnv *env, jclass class, jobject bitmap, int radius) {
    if (!bitmap) {
        return;
    }
...
JNIEXPORT void JNICALL Java_swe574_boun_edu_androidproject_tools_AndroidUtilities_loadBitmap(JNIEnv *env, jclass class, jstring path, jobject bitmap, int scale, int width, int height, int stride) {
