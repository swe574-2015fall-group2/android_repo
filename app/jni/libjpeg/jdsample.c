...
start_pass_upsample(j_decompress_ptr
cinfo) {
...
if (v_expand > 1) {
jcopy_sample_rows(output_data, outrow, output_data, outrow
+ 1,
...
h2v1_upsample(j_decompress_ptr
cinfo,
jpeg_component_info *compptr,
        JSAMPARRAY
input_data,
...
h2v2_upsample(j_decompress_ptr
cinfo,
jpeg_component_info *compptr,
        JSAMPARRAY
input_data,
...
h2v1_fancy_upsample(j_decompress_ptr
cinfo,
jpeg_component_info *compptr,
        JSAMPARRAY
input_data,
...
upsample = (my_upsample_ptr)
        (*cinfo->mem->alloc_small)((j_common_ptr) cinfo, JPOOL_IMAGE,
                                   SIZEOF(my_upsampler));
cinfo->
upsample = (struct jpeg_upsampler *) upsample;
upsample->pub.
start_pass = start_pass_upsample;
upsample->pub.
upsample = sep_upsample;
upsample->pub.
