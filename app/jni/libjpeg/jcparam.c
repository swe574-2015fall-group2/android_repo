...
jpeg_add_quant_table(j_compress_ptr
cinfo,
int which_tbl,
const unsigned int *basic_table,
int scale_factor, boolean
force_baseline)
...
jpeg_set_quality(j_compress_ptr
cinfo,
int quality, boolean
force_baseline)
/* Set or change the 'quality' (quantization) setting, using default tables.
...
std_huff_tables(j_compress_ptr
cinfo)
...
jpeg_set_defaults(j_compress_ptr
cinfo) {
int i;
...
jpeg_default_colorspace(j_compress_ptr
cinfo) {
...
jpeg_set_colorspace(j_compress_ptr
cinfo,
...
cinfo->
write_Adobe_marker = FALSE; /* write no Adobe marker by default */
...
JCS_UNKNOWN:
        cinfo
->
num_components = cinfo->input_components;
