 ...
 */
public class GetGroupMeetingsTask extends AsyncTask<Void, Void, ArrayList<Meeting>> {
    ...
    public GetGroupMeetingsTask(Group mGroup, User mUser, ListView mParent, OnTaskCompleted mListener) {
        this.mGroup = mGroup;
        this.mUser = mUser;
